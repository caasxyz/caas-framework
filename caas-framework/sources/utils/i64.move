module dex_contract::i64 {
    ...
    #[deprecated]
    public fun from_u64(_v: u64): I64 {
        abort error::unavailable(EDEPRECATED)
    }
    ...
    #[deprecated]
    public fun eq(_num1: I64, _num2: I64): bool {
        abort error::unauthenticated(EDEPRECATED)
        // num1.bits == num2.bits
    }

    #[deprecated]
    public fun gt(_num1: I64, _num2: I64): bool {
        abort error::unauthenticated(EDEPRECATED)
        // cmp(num1, num2) == GT
    }

    #[deprecated]
    public fun gte(_num1: I64, _num2: I64): bool {
        abort error::unauthenticated(EDEPRECATED)
        // cmp(num1, num2) >= EQ
    }

    #[deprecated]
    public fun lt(_num1: I64, _num2: I64): bool {
        abort error::unauthenticated(EDEPRECATED)
        // cmp(num1, num2) == LT
    }

    #[deprecated]
    public fun lte(_num1: I64, _num2: I64): bool {
        abort error::unauthenticated(EDEPRECATED)
        // cmp(num1, num2) <= EQ
    }

    #[deprecated]
    public fun or(_num1: I64, _num2: I64): I64 {
        abort error::unauthenticated(EDEPRECATED)
    }

    #[deprecated]
    public fun and(_num1: I64, _num2: I64): I64 {
        abort error::unauthenticated(EDEPRECATED)
    }
