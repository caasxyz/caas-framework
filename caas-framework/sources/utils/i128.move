module caas_framework::i128 {
    use std::error;
    use caas_framework::i64;
    use caas_framework::i32;
    ...
    #[deprecated]
    public fun overflowing_sub(_num1: I128, _num2: I128): (I128, bool) {
        abort error::unavailable(EDEPRECATED)
    }
    ...
    #[deprecated]
    public fun as_i64(_v: I128): i64::I64 {
        abort error::unavailable(EDEPRECATED)
    }
    ...
    #[deprecated]
    public fun and(_num1: I128, _num2: I128): I128 {
        abort error::unavailable(EDEPRECATED)
    }
